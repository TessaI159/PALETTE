...
struct Color cielab_avg_fallback_cw(const struct Color colors,
				    struct Color cents, uint8_t which_cent) {
	uint16_t num_col = colors.num;
	float	 l	 = 0.0f;
	float	 a	 = 0.0f;
	float	 b	 = 0.0f;
...
struct Color oklab_avg_fallback(const struct Color colors, struct Color cents,
				uint8_t which_cent) {
	uint16_t num_col = colors.num;
	float	 l1, l2, l3, l4;
	float	 a1, a2, a3, a4;
...
void oklab_avg_fallback_cw(const struct Color colors,
				   struct Color cents, uint8_t which_cent) {
	uint16_t num_col = colors.num;
	float	 l	 = 0.0f;
	float	 a	 = 0.0f;
